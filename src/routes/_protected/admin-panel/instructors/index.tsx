...
export const Route = createFileRoute("/_protected/admin-panel/instructors/")({
...
function RouteComponent() {
  ...
  useHandleSearchParamsValidationFailure({
    ...
    onValidationFail: () => navigate({ to: "/admin-panel/instructors" }),
  });
    ...
    return (
      <div className="size-full flex flex-col gap-16">
        <TitleAndCreateAction
          ...
          createAction={() =>
            navigate({ to: "/admin-panel/instructors/create" })
          }
        />
        <DataTable
          columns={columns}
