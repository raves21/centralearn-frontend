...
export const Route = createFileRoute("/_protected/admin-panel/classes/")({
...
function RouteComponent() {
  ...
  useHandleSearchParamsValidationFailure({
    ...
    onValidationFail: () => navigate({ to: "/admin-panel/classes" }),
  });
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent side="bottom" align="end">
              <DropdownMenuItem
                onClick={() =>
                  navigate({
                    to: "/admin-panel/classes/$classId/edit",
                    params: {
                      classId: rowClass.id,
                    },
                  })
    ...
    return (
      <div className="size-full flex flex-col gap-16">
        <TitleAndCreateAction
          headerTitle="Classes"
          createAction={() => navigate({ to: "/admin-panel/classes/create" })}
        />
        <DataTable
          columns={columns}
          data={data.data}
