...
export const Route = createFileRoute("/_protected/admin-panel/admins/")({
...
function RouteComponent() {
  ...
  useHandleSearchParamsValidationFailure({
    ...
    onValidationFail: () => navigate({ to: "/admin-panel/admins" }),
  });
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent side="bottom" align="end">
              <DropdownMenuItem
                onClick={() =>
                  navigate({
                    to: "/admin-panel/admins/$adminId/edit",
                    params: {
                      adminId: admin.id,
                    },
                  })
    ...
    return (
      <div className="size-full flex flex-col gap-16">
        <TitleAndCreateAction
          headerTitle="Admins"
          createAction={() => navigate({ to: "/admin-panel/admins/create" })}
        />
        <DataTable
          columns={columns}
          data={data.data}
