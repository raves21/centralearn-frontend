...
export const Route = createFileRoute("/_protected/admin-panel/departments/")({
...
function RouteComponent() {
  ...
  useHandleSearchParamsValidationFailure({
    ...
    onValidationFail: () => navigate({ to: "/admin-panel/departments" }),
  });
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent side="bottom" align="end">
              <DropdownMenuItem
                onClick={() =>
                  navigate({
                    to: "/admin-panel/departments/$departmentId/edit",
                    params: {
    ...
    return (
      <div className="size-full flex flex-col gap-16">
        <TitleAndCreateAction
          ...
          createAction={() =>
            navigate({ to: "/admin-panel/departments/create" })
          }
        />
        <DataTable
          columns={columns}
